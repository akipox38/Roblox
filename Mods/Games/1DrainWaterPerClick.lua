...
local Event = game:GetService("ReplicatedStorage").Remote.Event.Upgrade["[C-S]BuyCashUpgrade"]
Event:FireServer(
    "Speed"
)

game:GetService("Players").LocalPlayer.PlayerGui.Main.Upgrades.Main.ScrollingFrame["1"]["1"].Max



workspace.PlayerEar["3"]["\231\142\169\229\174\182\229\140\186\229\159\159"]["\230\148\182\233\155\134\230\140\137\233\146\174"].Touch
